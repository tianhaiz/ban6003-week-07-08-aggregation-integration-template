# BAN 6003 Weeks 7-8: Aggregation, Reshaping, and Data Integration

**BAN 6003: Data Management and Analytics Integration**  
**Weeks 7-8 GitHub Classroom Template**
...
- `notebooks/module7_aggregation_reshaping_guided_lab.ipynb`
- `notebooks/module8_pandas_integration_guided_lab.ipynb`
...
```bash
git add .
git commit -m "Complete Weeks 7-8 BAN 6003 assignment"
git push
```
